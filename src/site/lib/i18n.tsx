...
const STRINGS = {
  en: {
    ...
    about: {
      ...
      foundersEyebrow: "The Beginning", foundersTitle: "Our Founders",
      leadershipEyebrow: "Guiding the Mission", leadershipTitle: "Leadership",
      teamEyebrow: "On the Ground", teamTitle: "Team Members",
      locationsEyebrow: "Where We Serve", locationsTitle: "Our Locations",
      journeyEyebrow: "The Story Behind the Mission", journeyTitle: "Our Founders' Journey",
      journeyDesc: "One By One Ministries was born from the story of two people, two continents, and one calling.",
    },
    contact: {
  ...
  fr: {
    ...
    about: {
      ...
      foundersEyebrow: "Le Commencement", foundersTitle: "Nos Fondateurs",
      leadershipEyebrow: "Guider la Mission", leadershipTitle: "Leadership",
      teamEyebrow: "Sur le Terrain", teamTitle: "Membres de l'Équipe",
      locationsEyebrow: "Où Nous Servons", locationsTitle: "Nos Lieux",
      journeyEyebrow: "L'Histoire Derrière la Mission", journeyTitle: "Le Parcours de Nos Fondateurs",
      journeyDesc: "One By One Ministries est né de l'histoire de deux personnes, deux continents et un seul appel.",
    },
    contact: {
  ...
  sw: {
    ...
    about: {
      ...
      foundersEyebrow: "Mwanzo", foundersTitle: "Waanzilishi Wetu",
      leadershipEyebrow: "Kuongoza Dhamira", leadershipTitle: "Uongozi",
      teamEyebrow: "Uwanjani", teamTitle: "Wanachama wa Timu",
      locationsEyebrow: "Tunapohudumu", locationsTitle: "Maeneo Yetu",
      journeyEyebrow: "Hadithi Nyuma ya Dhamira", journeyTitle: "Safari ya Waanzilishi Wetu",
      journeyDesc: "One By One Ministries ilizaliwa kutoka hadithi ya watu wawili, mabara mawili na wito mmoja.",
    },
    contact: {
